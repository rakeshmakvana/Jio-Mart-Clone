                ...
                <div className="w-100 p-4">
                    <div className='w-100 mb-2'>
                        <div className='w-100 main-a mb-2'>
                            <span>Sales <IoIosArrowForward /> Sale Details</span>
                        </div>
                    </div>
                            ...
                            <div className="col-12 cart-box">
                                ...
                                <div className='p-4 mb-3'>
                                    ...
                                    <span className='w-100 sp'>
                                        Response :- <span className='text-success'>Conform</span>
                                    </span>
                                    <h3 className='w-100 mt-2'>
                                        Sale :- <span className='text-success'>Done</span>
                                    </h3>
                                </div>
                            </div>
                        </div>
